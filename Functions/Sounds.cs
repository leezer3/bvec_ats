...
namespace Plugin
{
    ...
    internal static class SoundManager
    {
        ...
        {
	        if (soundIndex == -1 || SoundHandles[soundIndex] == null) return;
	        SoundHandles[soundIndex].Stop();
        ...
        {
	        return soundIndex != -1 && SoundHandles[soundIndex] != null && SoundHandles[soundIndex].Playing;
        }
