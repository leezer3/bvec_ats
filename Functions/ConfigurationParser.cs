...
namespace Plugin
{
	partial class InternalFunctions
	{
		...
		internal static void ParseKey(string input, ref VirtualKeys? output, string failingvalue)
		{
			try
			{
			...
			{
				case "s":
					output = VirtualKeys.S;
					break;
				case "a1":
					output = VirtualKeys.A1;
					break;
				case "a2":
					output = VirtualKeys.A2;
					break;
				case "b1":
					output = VirtualKeys.B1;
					break;
				case "b2":
					output = VirtualKeys.B2;
					break;
				case "c1":
					output = VirtualKeys.C1;
					break;
				case "c2":
					output = VirtualKeys.C2;
					break;
				case "d":
					output = VirtualKeys.D;
					break;
				case "e":
					output = VirtualKeys.E;
					break;
				case "f":
					output = VirtualKeys.F;
					break;
				case "g":
					output = VirtualKeys.G;
					break;
				case "h":
					output = VirtualKeys.H;
					break;
				case "i":
					output = VirtualKeys.I;
					break;
				case "j":
					output = VirtualKeys.J;
					break;
				case "k":
					output = VirtualKeys.K;
					break;
				case "l":
					output = VirtualKeys.L;
					break;
